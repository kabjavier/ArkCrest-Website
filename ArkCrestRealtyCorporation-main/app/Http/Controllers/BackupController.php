...
class BackupController extends Controller
{
    ...
    public function createExcel(Request $request)
    {
        ...
        try {
            $filename = $this->backups->createExcelBackup();
    ...
    public function restore(Request $request, string $filename)
    {
        ...
        try {
            $path = $this->backups->diskPathFor($filename);
            $result = $this->backups->restoreFromExcel($path);
    ...
    /**
     * Restore from a freshly uploaded Excel file (from the admin's local device),
    ...
    public function uploadAndRestore(Request $request)
    {
        ...
        $request->validate([
            'restore_file' => ['required', 'file', 'mimes:xlsx'],
        ]);
        ...
        try {
            ...
            $result = $this->backups->restoreFromExcel($absolutePath);
