...
<div class="backup-container">
    ...
    <div class="backup-card">
        ...
        <p style="font-size:13px;color:#6b7280;margin:0 0 16px;">
            An Excel backup includes every table in the system ({{ count($tables) }} tables) and can be used to restore the database later.
            A PDF export is for viewing/printing only and cannot be used to restore.
        </p>
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
            <form method="POST" action="{{ route('backup.create-excel') }}" onsubmit="return confirmAndLoad(this, 'Create a new Excel backup of the entire system now?', 'Creating backup…')">
                @csrf
            ...
            <table class="backup-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($b['type'] === 'xlsx')
                                <span class="backup-badge backup-badge-xlsx">EXCEL</span>
                            @else
    ...
    <div class="backup-card">
        ...
        <p style="font-size:13px;color:#6b7280;margin:0 0 16px;">
            Upload a previously downloaded <strong>.xlsx</strong> backup file from your computer to restore the system with it.
        </p>
        <form id="uploadRestoreForm" method="POST" action="{{ route('backup.upload-restore') }}" enctype="multipart/form-data"
            ...
            <div style="display:flex;gap:12px;align-items:center;flex-wrap:wrap;">
                <input type="file" name="restore_file" id="uploadRestoreFile" accept=".xlsx" required
...
<style>
    ...
    .backup-badge-xlsx { background:#dcfce7; color:#166534; }
...
// Used by the "Create Excel Backup" / "Create PDF Export" forms.
...
// Override submitRestore's target-building for the uploaded-file case
const _origSubmitRestore = submitRestore;
